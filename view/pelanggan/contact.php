...
<body>
    ...
    <div class="container">
        ...
        <div id="popupDialog"
            style="display:none; position:fixed; top:50%; left:50%; transform:translate(-50%, -50%); padding:20px; background:white; border:1px solid black; z-index:1000;">
            <p id="popupMessage"></p>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#contactForm").on("submit", function (event) {
                ...
                $.ajax({
                    url: 'view/pelanggan/proses.php', // Path ke proses.php
                    type: 'POST',
                    data: formData,
                    dataType: 'json',
                    ...
                    error: function (xhr) {
                        ...
                        showPopup(response.message || 'Terjadi kesalahan.');
                    }
                });
            });
